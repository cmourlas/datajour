...
print("The second-to-last element", countries[-2])
...
for a in cities:
  if a['latitude'] > 0:
    print(a['name'], "it is above equator")
  elif a['latitude'] < 0:
    print(a['name'], "it is below equator")
  if a['latitude'] == int(-51796253):
...
for loc in cities:
  if loc['latitude'] > tree['latitude']:
    ...
    print(loc['name'], "is north of your tree")
  elif loc['latitude'] < tree['latitude']:
    location_to_tree = 'below'
    print(loc['name'],"is south of your tree")
